...
public class CopiedUrlClassLoader  extends SecureClassLoader implements Closeable {
     ...
     */
    public CopiedUrlClassLoader(URL[] urls, ClassLoader parent) {
        super(parent);
    ...
    CopiedUrlClassLoader(URL[] urls, ClassLoader parent,
     ...
     * @see SecurityManager#checkCreateClassLoader
     */
    public CopiedUrlClassLoader(URL[] urls) {
        super();
        // this is to make the stack depth consistent with 1.1
        SecurityManager security = System.getSecurityManager();
        if (security != null) {
    ...
    CopiedUrlClassLoader(URL[] urls, AccessControlContext acc) {
        super();
        // this is to make the stack depth consistent with 1.1
        SecurityManager security = System.getSecurityManager();
        if (security != null) {
