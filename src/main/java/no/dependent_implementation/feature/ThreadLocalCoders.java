...
public class ThreadLocalCoders {
    ...
    private static ThreadLocalCoders.Cache decoderCache = new  ThreadLocalCoders.Cache(CACHE_SIZE) {
    ...
    private static ThreadLocalCoders.Cache encoderCache = new ThreadLocalCoders.Cache(CACHE_SIZE) {
        boolean hasName(Object ob, Object name) {
            if (name instanceof String)
